...
class Router {
  ...
  run (def, obj, prefix) {
    ...
    this.app.get(prefix + '/queue/exit/in/:card', async (res, req) => {
      ...
      await this.queue(res, req, def, obj, true, false, false, false, def.REQ_EXIT_IN, obj.exitQueue)
    })
    this.app.get(prefix + '/queue/exit/out/:card', async (res, req) => {
      ...
      await this.queue(res, req, def, obj, false, true, false, false, def.REQ_EXIT_OUT, obj.exitQueue)
    })
    this.app.get(prefix + '/queue/swap/ev/in/:card', async (res, req) => {
      await this.queue(res, req, def, obj, true, false, true, false, def.REQ_SWAP_IN, obj.swapQueue)
    })
    this.app.get(prefix + '/queue/swap/ev/out/:card', async (res, req) => {
      await this.queue(res, req, def, obj, false, true, true, false, def.REQ_SWAP_OUT, obj.swapQueue)
    })
    this.app.get(prefix + '/queue/swap/st/in/:card', async (res, req) => {
      await this.queue(res, req, def, obj, true, false, false, true, def.REQ_SWAP_IN, obj.swapQueue)
    })
    this.app.get(prefix + '/queue/swap/st/out/:card', async (res, req) => {
      await this.queue(res, req, def, obj, false, true, false, true, def.REQ_SWAP_OUT, obj.swapQueue)
    })
